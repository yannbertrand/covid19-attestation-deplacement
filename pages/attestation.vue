...
déplacements dans le cadre de la lutte contre la propagation du virus Covid-19 :</h2>
    ...
    <p>Je soussigné(e)</p>
    <table>
      <tr><th>Mme / M.</th><td>{{ this.nom }}</td></tr>
      <tr><th>Né(e) le :</th><td>{{ this.naissance }}</td></tr>
      <tr><th>Demeurant :</th><td>{{ this.adresse }}</td></tr>
    </table>
...
des animaux de compagnie.</label></li>
    ...
    <p id="date">Fait à {{ this.lieu }} le {{ this.date }}</p>
  </div>
</template>
